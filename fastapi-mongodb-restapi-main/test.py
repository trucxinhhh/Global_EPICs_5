...
for i in Num:
    ...
    print(c)
    if i <=0.5: 
        check.append(" LED : OFF, CEILING FANS : OFF, FAN : OFF,X  ")
        # print(i,"1") 
        print(" LED  : OFF, CEILING FANS : OFF, FAN : OFF "X,)
        time.sleep(0.5)
    # elif i > 0.5 and i <=1.5 : 
    #     check.append(" LED1 : OFF, CEILING FANS : OFF, FAN : ON,X ")
    #     # print(i,"2")
    #     print(" LED : OFF,CEILING FANS : OFF, FAN : ON ")
    #     time.sleep(0.5)
    # elif i > 1.5 and i <=2.5: 
    #     check.append(" LED : OFF, CEILING FANS : ON, FAN : OFF ,X")
    #     # print(i, '3')
    #     print(" LED 1 : OFF, CEILING FANS : ON, FAN : OFF ")
    #     time.sleep(0.5)
    # elif i >2.5    and i <= 3.5 : 
    #     check.append(" LED : OFF, CEILING FANS : ON, FAN : ON ",X)
    #     # print(i,'4')
    #     print(" LED : OFF, CEILING FANS: ON, FAN : ON ")
    #     time.sleep(0.5)
    # elif i > 3.5  and i <= 4.5 : 
    #     check.append(" LED : ON, CEILING FANS : OFF, FAN : OFF ,X")
    #     # print(i,'5') 
    ...
    #     check.append(" LED : ON, CEILING FANS : ON, FAN : OFF ",X)
    #     # print(i,'7')
    #     print(" LED : ON, CEILING FANS: ON, FAN : OFF ")
    #     time.sleep(0.5)
    # elif i > 6.5 and i<= 7 :
    #     check.append(" LED : ON, CEILING FANS : ON, FAN : ON "),X  
    #     print(" LED : ON, CEILING FANS : ON, FAN : ON ")  
    #     # print(i,'8')
    #     time.sleep(0.5)
    else :
         check.append("DEVICE IS PROBLEM!!!")
         print("DEVICE IS PROBLEM !!!",X)
        #  print(i,'9')
         time.sleep(0.5)
print(check[-1])
